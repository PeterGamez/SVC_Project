...
class Mail
{
    final public static function sendMail(string $email, string $subject, string $body): bool
    {
    ...
    final public static function verifypage(string $link): string
    {
    ...
    final public static function registerpage(string $link): string
    {
