...
class AlertLogin extends Alert
{
    ...
    final public static function unverifyEmail(): string
    {
        return parent::alerts('ไม่สามารถส่งอีเมลยืนยันได้', 'error', 1500, 'window.location.href="' . member_url('login') . '"');
    }

    final public static function reverifyEmail(): string
    {
    ...
    final public static function succeed(): string
    {
