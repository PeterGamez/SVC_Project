...
use App\Models\WhitelistWaiting as ModelsWhitelistWaiting;

class WhitelistWaiting
{
    ...
    public static function approve()
    {
        if ($_POST['id']) {
            ...
            $data = ModelsWhitelistWaiting::find()->where('id', $id)->getOne();
            if (!$data) {
            ...
            if ($approve_id == 2) {
                ...
                ModelsWhitelistWaiting::delete(['id' => $id]);
            ...
            // อื่นๆ
                ...
                ModelsWhitelistWaiting::update(['id' => $id], [
                    'approve_id' => $approve_id,
                    'approve_reason' => $approve_reason,
                    'approve_by' => $_SESSION['user_id'],
                    'approve_at' => date('Y-m-d H:i:s')
